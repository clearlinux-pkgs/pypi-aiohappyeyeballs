...
Source0  : https://files.pythonhosted.org/packages/2d/f7/22bba300a16fd1cad99da1a23793fe43963ee326d012fdf852d0b4035955/aiohappyeyeballs-2.4.0.tar.gz
...
%prep
%setup -q -n aiohappyeyeballs-2.4.0
cd %{_builddir}/aiohappyeyeballs-2.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724104618
