...
Source0  : https://files.pythonhosted.org/packages/cc/83/f731ac54f82fc25984ee4d6abadf69b824dde03b629a1348f459e7b35d5a/aiohappyeyeballs-2.3.2.tar.gz
...
%prep
%setup -q -n aiohappyeyeballs-2.3.2
cd %{_builddir}/aiohappyeyeballs-2.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722441774
